...
flags.DEFINE_string('model_name', 'model_lstm_hybrid_output_mod-vinyals_1lr_hid500_proj500_en30000_pt30000_maxNrm5_adam_dropout-off_input-feed-off_att.ckpt',
                           'Model name')
flags.DEFINE_string('data_dir', '/home/gian/data/', 'Data directory')
flags.DEFINE_string('train_dir', '/home/gian/train_global/model_lstm_hybrid_output_mod-vinyals_1lr_hid500_proj500_en30000_pt30000_maxNrm5_adam_dropout-off_input-feed-off_att/', 'Train directory')
...
flags.DEFINE_integer('early_stop_patience', 0, 'How many training steps to monitor.')
