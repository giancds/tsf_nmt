...
tf.app.flags.DEFINE_boolean('local_attention', False, 'Whether to use local attention (or global attention).')
...
tf.app.flags.DEFINE_integer('encoder_size', 300, 'Size of each encoder layer.')
tf.app.flags.DEFINE_integer('decoder_size', 300, 'Size of each decoder layer.')
...
tf.app.flags.DEFINE_string('model_name', 'model_lstm_hid300_proj100_en30000_pt30000_sgd1.0.ckpt', 'Data directory')
tf.app.flags.DEFINE_string('data_dir', '/home/gian/data/', 'Data directory')
tf.app.flags.DEFINE_string('train_dir', '/home/gian/train/', 'Train directory')
