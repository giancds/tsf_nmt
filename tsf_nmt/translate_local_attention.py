...
flags.DEFINE_string('attention_type', attention.LOCAL, 'Which type of attention to use. One of local, global and hybrid.')
...
flags.DEFINE_string('model_name', 'seq2seq_gru_local_informed_output_type2_vinyals_1lr_hid500_proj500_en30000_pt30000_maxNrm5_adam_dropout-off_input-feed-off_att.ckpt',
                           'Model name')
flags.DEFINE_string('data_dir', '/home/gian/data/', 'Data directory')
flags.DEFINE_string('train_dir', '/home/gian/train_local/seq2seq_gru_local_informed_output_type2_vinyals_1lr_hid500_proj500_en30000_pt30000_maxNrm5_adam_dropout-off_input-feed-off_att/', 'Train directory')
